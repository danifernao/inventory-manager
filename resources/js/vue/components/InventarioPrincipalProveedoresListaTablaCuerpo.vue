    ...
    <tbody>
        <template v-if="registros.length">
            <tr v-for="registro in registros">
                <Celda tipo="imagen" clase="imagen" icono="truck-ramp-box" :url="$route.path + '/' + registro.id" :imgUrl="registro.logotipo_url" imgDescripcion="Logotipo del proveedor" titulo="Ver detalles del proveedor"/>
                <Celda clase="nombre" :url="$route.path + '/' + registro.id" titulo="Ver detalles del proveedor" :dato="registro.nombre"/>
                <Celda clase="nit" :url="$route.path + '/' + registro.id" titulo="Ver detalles del proveedor" :dato="registro.nit"/>
                <Celda clase="ubicacion" :url="$route.path + '/' + registro.id" titulo="Ver detalles del proveedor" :dato="registro.ubicacion"/>
                <Celda clase="nro-unidades" :url="$route.path + '/' + registro.id" titulo="Ver detalles del proveedor" :dato="registro.unidades_count"/>
