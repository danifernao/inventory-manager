<template>
    <div class="envoltorio">
        ...
        <Lista componente="fabricantes" ordenPor="nombre" :titulo="titulo" @en-bodega="estaEnBodega" @en-proyecto="estaEnProyecto" @api-lista="obtenerApiUrl"/>
        <Archivo :url="archivoUrl" nombre="fabricantes.xlsx" v-if="archivoUrl" @descargado="descargaFinalizada"/>
    </div>
</template>
        ...
        computed: {
            titulo() {
                if (this.ruta('proyectos')) {
                    if (this.enProyecto) {
                        return 'Fabricantes con unidades en este proyecto'
                    } else {
                        return 'Fabricantes sin unidades en este proyecto'
                    }
                } else {
                    if (this.enBodega) {
                        return 'Fabricantes con unidades en esta bodega'
                    } else {
                        return 'Fabricantes sin unidades en esta bodega'
                    }
                }
            },
            opciones() {
